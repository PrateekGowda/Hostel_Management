...
$sql ="select (S.*,E.test1, E.test2, E.test3, R.roomno, R.block_no, R.floorno, V.name, V.relation, V.v_date, V.visiting_time) from ( student S, education E, room R, visitor V WHERE S.lfno=R.lfno AND S.lfno=V.lfno  AND S.usn=E.usn AND S.lfno= (SELECT S.lfno from student S WHERE S.lfno=26))";
